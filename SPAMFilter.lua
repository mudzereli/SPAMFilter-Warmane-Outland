...
SlashCmdList["SPAMFILTER"] = function(msg)
	...
	elseif msg == "blocked" or msg == "block" or msg == "b" then
		...
		DEFAULT_CHAT_FRAME:AddMessage("["..EnabledBoolean(filterSPAM).."] |r "..cOrange.."/sf toggle|r:        toggle ALL SPAM filtering.")
		DEFAULT_CHAT_FRAME:AddMessage("["..EnabledBoolean(verbose).."] |r "..cOrange.."/sf verbose|r:     Display filtered messages.")
